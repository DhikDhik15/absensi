    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <h1 class="text-gray-900">Selamat Datang Teman</h1>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold text-gray-900 dark:text-white">Scheduled</div>
                            </div>

                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    Absensi yang sudah terjadwal.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold text-gray-900 dark:text-white">Counted</div>
                            </div>

                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    Dapat menghitung sendiri jumlah absensi.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold text-gray-900 dark:text-white">Dokumentasi</div>
                            </div>

                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    Ada panduan teknis cara penggunaan aplikasi.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold text-gray-900 dark:text-white">Berita</div>
                            </div>

                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    Dapatkan informasi terbaru terkait kegiatan kantor.
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <br/>
                <div class="flex justify-center  mt-5 sm:items-center sm:justify-between">
                    <div class="text-center text-sm text-gray-700 sm:text-left">
                        <div class="flex items-center">
                            ...
                            <a href="https://sophismata.co.id">
                                Company Profile
                            </a>
                        </div>
                    </div>

                    <div class="ml-3 text-end text-sm text-gray-700 sm:text-right sm:ml-0">
